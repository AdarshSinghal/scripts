...
echo "$(date +'%Y-%m-%d %H:%M:%S') - Started executing 02-installation.sh, which is present in $ENV_SCRIPT_DIR." >> "$INSTALLATION_LOG_FILE"

SCRIPT_JDK_MVN_INSTALL=$ENV_SCRIPT_DIR/03-installation-jdk-mvn.sh
