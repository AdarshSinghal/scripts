...
sudo -u postgres psql -U postgres -d postgres -c "alter user postgres with password 'NEW_PASSWORD';"
...
echo "8 - Complted. Adding ufw rule..." >> "$LOG_FILE"
sudo ufw allow 5432/tcp
echo "9 - Completed. Updated ufw rule" >> "$LOG_FILE"
echo "10 - Completed all steps" >> "$LOG_FILE"